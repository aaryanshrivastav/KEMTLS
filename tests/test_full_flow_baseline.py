...
def test_full_baseline_flow_across_auth_and_resource_servers(monkeypatch):
    ...
    auth_app = create_auth_server_app(
        {
            ...
            "kemtls_modes_supported": ["baseline", "auto"],
        }
    )
    ...
    assert introspection.get_json()["handshake_mode_seen"] == "baseline"
